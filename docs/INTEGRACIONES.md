...
## 2. Adaptadores en `src/infrastructure/apiAdapters.js`

Ese archivo contiene la logica de llamadas:
...
Si el contrato de un grupo cambia, se modifica ahi.
...
-> intentDetector.js detecta stock_info
-> processMessage.js pide producto al catalogo
-> apiAdapters.js llama a G3
-> apiAdapters.js llama a G7
